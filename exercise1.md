...
In this exercise, you will use the Azure Portal to create the resources needed for the other labs: a Web App, SQL DB, Key Vault and Storage. We'll also create an AAD group to manage users with.
...
3. Click the **Create button** at the bottom to have the Key Vault created.
...
### Create an AAD Group
In order to work with AAD users and Managed Identity with resources, it is easier to create a group to add both users and any Managed Identity service principles. So now, let's create a group and put your user in it.
